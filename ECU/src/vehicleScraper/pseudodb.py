carBrands = [
		...
		'harley-davidson', 'hennessey', 'honda', 'hyundai', 'infiniti', 'infinity', 'isuzu', 'jaguar', 'jeep', 'karma',
		...
		'rezvani', 'rivian', 'rolls royce', 'rolls-royce', 'rossion', 'rover', 'saleen', 'saturn', 'shelby', 'sofia', 'spyker', 'ssc', 'studebaker',
		'subaru', 'suzuki', 'tesla', 'toyota', 'trion', 'tvr', 'valmet', 'volkswagen', 'volvo', 'vw', 'zimmer'
	]
